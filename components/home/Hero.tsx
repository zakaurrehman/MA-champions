...
export default function Hero() {
  return (
    <section className="relative isolate overflow-hidden bg-ink" aria-labelledby="hero-title">
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(120% 80% at 50% -10%, rgba(242,217,139,0.16) 0%, rgba(201,150,46,0.06) 28%, transparent 62%)',
        }}
      />
      <div
        aria-hidden="true"
        ...
        style={{
          background: 'linear-gradient(to top, rgba(94,20,28,0.20), transparent)',
        }}
      />
      ...
      <div className="mx-auto grid max-w-7xl gap-12 px-4 pb-20 pt-16 sm:px-6 sm:pb-24 sm:pt-20 lg:grid-cols-2 lg:items-center lg:gap-8 lg:pb-28 lg:pt-24">
        ...
        <div className="reveal max-w-xl">
          <p className="mb-5 font-body text-2xs font-semibold uppercase tracking-[0.24em] text-nickel">
            In-house manufacturing · Worldwide shipping
          </p>

          <h1
            id="hero-title"
            className="text-4xl leading-[0.92] text-bone sm:text-5xl lg:text-6xl"
          >
            Custom championship
            <br />
        ...
        <div className="relative">
          <div className="border-plate plate-sheen relative aspect-[4/3] overflow-hidden rounded-[--radius-plate] bg-ink-raised">
            {HERO_IMAGE ? (
              <Image
                src={HERO_IMAGE.src}
                alt={HERO_IMAGE.alt}
              ...
              <div className="leather-grain grid h-full place-items-center px-6 text-center">
                <div>
                  ...
                  <p className="mx-auto mt-5 max-w-xs text-sm leading-relaxed text-bone-dim">
          ...
          <div
            ...
            style={{
              background:
                'radial-gradient(60% 100% at 50% 0%, rgba(201,150,46,0.13), transparent 70%)',
            }}
          />
        </div>
      </div>
